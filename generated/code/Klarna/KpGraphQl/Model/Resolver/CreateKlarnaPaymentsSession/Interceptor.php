...
class Interceptor extends \Klarna\KpGraphQl\Model\Resolver\CreateKlarnaPaymentsSession implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Klarna\Core\Helper\ConfigHelper $configHelper, \Klarna\Kp\Model\Session $session, \Magento\QuoteGraphQl\Model\Cart\GetCartForUser $getCartForUser, \Magento\Framework\App\RequestInterface $request)
    {
        $this->___init();
        parent::__construct($configHelper, $session, $getCartForUser, $request);
    }
